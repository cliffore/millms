...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.err.println("Usage: java -jar millms-owlapi.jar <level: s|v>");
            return;
        }
        ...
        File folder = new File("../../../../input-data/ontologies");
        ...
        for (File file : files) {
            try {
                ...
                System.err.println("File processed: " + file);
            } catch (Exception e) {
        ...
        writer.close();
        System.out.println("Done. Output written to ontology_classes_" + (level.equals("v") ? "verbose.csv" : "summary.csv") + ".csv");
    }
